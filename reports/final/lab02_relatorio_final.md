...
| Manual | 6 | 212,492 | 167,595 | 79,193 | 326,498 | 247,305 |
...
A mediana foi de 112,50 s com IA e 167,595 s no tratamento Manual. O Wilcoxon pareado pelas medianas individuais resultou em **W = 2,0** e **p = 0,75**. A diferença observada é descritiva e não constitui evidência estatística suficiente de efeito do tratamento.
...
A hipótese de menor tempo com IA foi parcialmente apoiada pela descrição dos dados: média e mediana foram menores nesse tratamento. Entretanto, o teste pareado não detectou diferença estatística, e a direção individual não foi uniforme entre os três participantes. Assim, RQ1 sugere uma possível vantagem temporal nesta amostra, mas não permite afirmar causalidade.
...
O Laboratório 02 comparou seis trials com IA e seis manuais, totalizando 12 execuções e 12 artefatos estruturais. Em RQ1, IA apresentou mediana de 112,50 s, contra 167,595 s em Manual, mas sem diferença estatisticamente detectável. Em RQ2, os dois tratamentos concluíram todos os testes com sucesso.
